...
import com.mypakuser.databinding.FragmentParcelPickupBinding;
...
public class ParcelPickupFragment extends Fragment
    ...
    Context mContext;
    GoogleMap mMap;
    FragmentParcelPickupBinding binding;
    LatLng pickUpLatLng;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.inflate(inflater,R.layout.fragment_parcel_pickup, container, false);
        inti();
    ...
    private void inti() {
        ...
        mapFragment.getMapAsync(ParcelPickupFragment.this);
        ...
        binding.btNext.setOnClickListener(v -> {
            ...
            if(pickUpLatLng != null) {
                params.put("pickup_location",binding.tvAddress.getText().toString().trim());
                params.put("pickup_lat", String.valueOf(pickUpLatLng.latitude));
                params.put("pickup_lon", String.valueOf(pickUpLatLng.longitude));
            } else {
                Toast.makeText(mContext, getString(R.string.please_pick_loc), Toast.LENGTH_SHORT).show();
            }

            ((ParcelUploadAct) getActivity()).loadFragment(new ParcelDeliveryFragment(params));
